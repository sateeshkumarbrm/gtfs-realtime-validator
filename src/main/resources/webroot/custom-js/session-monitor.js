...
function refresh() {
    ...
    $.get(server + "/api/gtfs-rt-feed/" + gtfsRtId + "/summary/pagination/" + paginationSummary["currentPage"] + "/" + paginationSummary["rowsPerPage"] +
            "/log/" + hideErrors + "/pagination/" + paginationLog["currentPage"] + "/" + paginationLog["rowsPerPage"] +
            "/" + sessionStartTime + "/" + sessionEndTime).done(function (data) {
